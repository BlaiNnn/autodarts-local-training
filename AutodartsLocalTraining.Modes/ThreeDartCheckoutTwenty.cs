...
public sealed class ThreeDartCheckoutTwenty : ITrainingMode
{
    
    private readonly List<DartThrowResult> _turnThrows = new();
    private static readonly int[] Targets = { 40, 60, 68, 72, 76, 80, 84, 88, 90, 92, 96, 98, 100, 108, 112, 116, 120, 140, 160, 170 };
